...
of the virus. We can then further separate the HA into clades (which are larger)
...
of a pango lineage is a group of viruses that ahve a shared ancestry. This can be from
a single synonymous mutation that has no affect of the viral protein structure. This 
unrestricted system of lineage designation has led to the designation of more than 
5,700 lineages. Along with a complete alphabet soup of lineage names.
:::
...
::: notes
There are three criteria for subclade proposal. Size, with larger groups having higher
priority of desigation. Divergence, with more mutations accumatlated, the higher the 
priority. And specific mutations of signifigance. These muations get weighted higher
for designation. 

Each of these components feeds into the calculation of normalized branch scores accross
the tree, with a threshold value of one set. This chosen threshold mean that any one score
...
::: notes
Shortening (aliasing) of names generally occurs after three hierarchical levels 
(i.e. D for C.1.1.1), but a new alias may be given earlier in the case of a rapid 
expansion or special designation.
:::
...
Images can be imbedded into the narrative sidebar or main display
